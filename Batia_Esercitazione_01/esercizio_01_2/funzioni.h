...
void scriviSuFile(const string& nomeFile, const vector<double>& dati1, const vector<double>& dati2, const vector<double>& dati3, const vector<double>& dati4, const vector<double>& dati5, const vector<double>& dati6, const vector<double>& dati7, const vector<double>& dati8, const vector<double>& dati9, const vector<double>& dati10, const vector<double>& dati11, const vector<double>& dati12); //Scrive su un file di output i risultati di un calcolo
