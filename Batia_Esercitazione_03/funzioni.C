...
void scriviSuFile(const string& nomeFile, const vector<double>& dati1, const vector<double>& dati2, const vector<double>& dati3, const vector<double>& dati4, const vector<double>& dati5, const vector<double>& dati6, const vector<double>& dati7, const vector<double>& dati8) {
    ...
    for (size_t i = 0; i < dati1.size(); ++i) {
        fileOutput << dati1[i] << "\t" << dati2[i] << "\t" << dati3[i] << "\t" << dati4[i] << "\t" << dati5[i] << "\t" << dati6[i] << "\t" << dati7[i] << "\t" << dati8[i]  << std::endl;
    }
