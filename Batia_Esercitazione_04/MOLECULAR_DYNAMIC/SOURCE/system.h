...
public: // Function declarations
  ...
  void initialize(string modello_input, string modello_output);          // Initialize system properties
  void initialize_properties(string modello_output);// Initialize properties for measurement
  void finalize(string modello_output);            // Finalize system and clean up
  void write_configuration(string modello_output); // Write final system configuration to XYZ file
  void write_XYZ(int nconf, string modello_output);  // Write system configuration in XYZ format on the fly
  void write_velocities(string modello_output);    // Write final particle velocities to file
  void read_configuration(string modello_output);  // Read system configuration from file
  void initialize_velocities(string modello_output);// Initialize particle velocities
  void step();                // Perform a simulation step
  void block_reset(int blk, string modello_output );  // Reset block averages
  void measure();             // Measure properties of the system
  void averages(int blk, string modello_output);     // Compute averages of properties
